  ...
  return (
    <div className="info">
      ...
      <p>
        ...
        <strong>
          {" "}
          Bachelor's Degree in Computer and Software Engineering from University
          of Rwanda
        </strong>{" "}
        and I have a good experience working in software development industry.
      </p>
      <h2>Technical Skills</h2>
      <ul>
        <li>Javascript (PREN, MERN stack)</li>
        <li>PHP / Laravel Framework</li>
        <li>Android (Java & Kotlin)</li>
        <li>Experience working with API query language (GraphQL)</li>
        <li>Test-Driven Development</li>
        <li>
          Full application development lifecycle (Development, Testing and
          Deployment)
        </li>
